...
| [2 — Auto-remediation + RCA copilot](phase-2-auto-remediation.md) | Telemetry that triggers action, not just alerts; RCAs grounded in an [incident corpus](../incidents/) | 🚧 in progress |
